...
class PollView extends Component {
    ...
    render() {
        ...
        const jalba = <React.Fragment>
            <DialogTitle classes={{root: classes.dialogTitleRoot}} id="simple-dialog-title">Жалоба на
                опрос</DialogTitle>
            <DialogContent>
                <ValidatorForm
                    fullWidth
                    ...
                    InputProps={
                        {
                            endAdornment: (
                                <InputAdornment position="end">
                                    <CopyToClipboard onCopy={this.onCopied}
                                                     text={"http://umnenie.com" + this.props.match.url}>
            ...
            <div>
                ...
                <div>
                    ...
                    >
                        <Hidden smDown>
                            <Grid item md={1}>
                                <Link className={this.state.polls.nextPoll === null && classes.disabeNavi}
                                      onClick={() => {
                                          this.PollNavigate(this.state.polls.nextPoll)
                                      }}>
                        ...
                        <Hidden smDown>
                            <Grid item md={1}>
                                <Link className={this.state.polls.prevPoll === null && classes.disabeNavi}
                                      onClick={() => {
                                          this.PollNavigate(this.state.polls.prevPoll)
                                      }}>
                                    <Paper classes={{root: classes.arrowButton}}>
                                    ...
                                    return (<div
                                        ...
                                        <div className="img_cont_msg">
                                            <Link to={url_User}><img
                                                alt={itemComment.user_name}
                                                src={itemComment.avatar}
                                                className="rounded-circle user_img_msg"/></Link>
                                        </div>
                                        <div className="msg_cotainer">
                                            {itemComment.user_name !== null &&
                                            <h5 className={classes.commentUser}>{itemComment.user_name}</h5>}
                                            {itemComment.text !== null ? itemComment.text :
                                                <img alt={itemComment.user_name} style={{width: '100%'}}
                                                     src={itemComment.file}/>}
